      ...
      <main className="container mx-auto px-4 pt-20">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button onClick={() => setIsCreateModalOpen(true)} className="text-slate-50">
              Create Event
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            length: 6
          }).map((_, index) => <EventCardSkeleton key={index} />) : filteredEvents?.map(event => <div key={event.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                  <div className="h-48 bg-sage-200 bg-cover bg-center" style={{
...
const EventCardSkeleton = () => <div className="bg-white rounded-lg shadow-sm overflow-hidden">
