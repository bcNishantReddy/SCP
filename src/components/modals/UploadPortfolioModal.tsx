  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const {
        error: uploadError,
        data
      } = await supabase.storage.from('files').upload(`portfolios/${fileName}`, file);
      ...
      <DialogContent className="sm:max-w-[525px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="portfolio-title" value={title} onChange={handleTitleChange} maxLength={50} />
          ...
          <div className="grid gap-2">
            ...
            {file && <p className="text-sm text-sage-600">
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="portfolio-description" className="min-h-[100px]" value={description} onChange={handleDescriptionChange} maxLength={200} />
            <p className="text-sm text-sage-600">
        ...
        <DialogFooter>
          ...
          <Button className="bg-sage-600 hover:bg-sage-700" onClick={handleUpload} disabled={isUploading}>
