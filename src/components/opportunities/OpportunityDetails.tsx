  ...
  return <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="flex justify-between items-start mb-6">
        {isEditing ? <div className="w-full">
          ...
          </div> : <h1 className="text-3xl font-bold text-sage-800">{opportunity.title}</h1>}
        ...
        {isEditing && <div className="flex gap-2">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700" onClick={handleUpdate}>
              Save Changes
            </Button>
          </div>}
      </div>
      ...
      <div className="space-y-6">
        {isEditing ? <>
            ...
            deadline: e.target.value
              ...
              <Input type="url" placeholder="Application Link" value={formData.application_link} onChange={e => setFormData({
            ...formData,
            ...
            <div className="flex items-center text-sage-600">
              ...
              {opportunity.deadline ? <span>
                  ...
                  {isExpired && <span className="ml-2 text-red-500 font-medium">(Closed)</span>}
                </span> : <span>No deadline specified</span>}
            </div>
            ...
            {!isExpired && opportunity.application_link && <div className="mt-8">
                <Button onClick={() => window.open(opportunity.application_link, '_blank')} className="w-full sm:w-auto bg-sage-600 hover:bg-sage-700 text-slate-50">
